...
public class CDimTeleport extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		if(args.length > 0 && args.length < 3) {
			...
			String dimName = "defString";
			WorldProvider dim = DimensionManager.getWorld(dimID).provider;
			if(dim == null) {
				sender.addChatMessage((IChatComponent)new ChatComponentText((Object)EnumChatFormatting.RED + "Something goes wrong. Sorry :("));
				return;
			}
